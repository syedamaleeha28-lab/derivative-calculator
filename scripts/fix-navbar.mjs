  ...
  return (
    ...
    >
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12 flex items-center justify-between">
        ...
        <motion.div className="flex items-center gap-1.5 md:hidden">
          <FacebookSocialLink className="h-9 w-9" iconSize={16} />
          <button
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            <motion.div className="px-6 pt-4 pb-3 border-b border-slate-100">
              <BrandLogoLink
                variant="mobile"
...
// Fix accidental motion.div wrappers above - use plain div for non-animated sections
const fixed = navbar
  .replace('<motion.div className="hidden md:flex items-center gap-2">', '<div className="hidden md:flex items-center gap-2">')
  .replace('<motion.div className="flex items-center gap-1.5 md:hidden">', '<div className="flex items-center gap-1.5 md:hidden">')
  .replace('<motion.div className="px-6 pt-4 pb-3 border-b border-slate-100">', '<div className="px-6 pt-4 pb-3 border-b border-slate-100">');

fs.writeFileSync("src/components/Navbar.tsx", fixed);
