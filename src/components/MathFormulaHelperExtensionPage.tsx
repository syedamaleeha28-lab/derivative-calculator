...
import {
  buildMathFormulaHelperSchemaGraph,
  MATH_FORMULA_HELPER_BENEFITS,
  MATH_FORMULA_HELPER_FAQS,
  MATH_FORMULA_HELPER_FEATURES,
  MATH_FORMULA_HELPER_INTERNAL_LINKS,
  MATH_FORMULA_HELPER_STEPS,
} from "@/lib/math-formula-helper-extension";

const FEATURE_ICONS = [Copy, BookOpen, FileCode, Layers, ExternalLink] as const;
const BENEFIT_ICONS = [GraduationCap, BookOpen, Wrench, Layers] as const;

const jsonLd = JSON.stringify(buildMathFormulaHelperSchemaGraph()).replace(/</g, "\\u003c");

export default function MathFormulaHelperExtensionPage() {
  return (
    <>
      <Script
        id="math-formula-helper-jsonld"
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <span className="text-sm font-medium normal-case tracking-normal text-slate-700">
                Math Formula Helper Chrome Extension
              </span>
            </nav>
            ...
            <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
              <div>
                ...
                <p className="mb-8 max-w-xl text-lg leading-relaxed text-slate-600">
                  Math Formula Helper is a free chrome math extension for students, engineers, and
                  math learners. Copy symbols, save formulas in a personal formula organizer,
                  convert expressions with a built-in latex converter extension, and open derivative
                  rule templates plus calculus resources from{" "}
                  <strong className="font-semibold text-slate-800">calculadora-derivadas.org</strong>
                  —your calculus helper extension in the browser toolbar.
                </p>
                <a
              ...
              <div
                ...
                role="img"
                aria-label="Math Formula Helper extension screenshot placeholder"
              >
                ...
                <div className="space-y-3 rounded-xl border border-slate-200/80 bg-white p-5 shadow-inner">
                  <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-slate-900">Formula &amp; Symbols</p>
                      <p className="text-xs text-slate-500">LaTeX · Notes · Calculus</p>
                    </div>
                  </div>
        ...
        <div className="mx-auto max-w-6xl space-y-16 px-4 py-14 sm:px-6 md:space-y-20 md:py-20 lg:px-8">
          ...
          <section aria-labelledby="extension-features-heading">
            <h2
              ...
              className="heading-font mb-3 text-2xl text-slate-900 md:text-3xl"
            >
              Features
            </h2>
            <p className="mb-8 max-w-3xl text-slate-600 leading-relaxed">
              Everything you need in one derivative calculator extension companion—symbols, storage,
              LaTeX, and quick calculus links.
            </p>
            <ul className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {MATH_FORMULA_HELPER_FEATURES.map((feature, i) => {
          ...
          <section aria-labelledby="extension-benefits-heading">
            ...
            >
              Who Benefits from Math Formula Helper?
            </h2>
            <div className="grid gap-5 md:grid-cols-2">
              {MATH_FORMULA_HELPER_BENEFITS.map((benefit, i) => {
          ...
          <section aria-labelledby="extension-how-heading">
            ...
            <ol className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {MATH_FORMULA_HELPER_STEPS.map((item) => (
                <li
                  key={item.step}
            ...
            <div className="mt-8 text-center">
              ...
              >
                Get Math Formula Helper on Chrome Web Store
          ...
          <section id="faq" className="scroll-mt-24" aria-labelledby="extension-faq-heading">
            ...
            <div className="space-y-4">
              {MATH_FORMULA_HELPER_FAQS.map((faq) => (
                <details
                  key={faq.q}
          ...
          >
            ...
            <p className="mb-5 max-w-2xl text-sm text-slate-600">
              Pair the math formula helper chrome extension with our free online derivative tools for
              full step-by-step solutions.
            </p>
            <ul className="flex flex-wrap gap-3">
              {MATH_FORMULA_HELPER_INTERNAL_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
          ...
          >
            <h2 id="extension-cta-heading" className="heading-font mb-3 text-2xl text-slate-900">
              Install Math Formula Helper Today
            </h2>
            <p className="mx-auto mb-6 max-w-xl text-slate-600">
              Free chrome math extension for formulas, symbols, LaTeX conversion, and derivative
              resources—built for students and STEM professionals.
            </p>
            <a
              href={CHROME_EXTENSION_URL}
              target="_blank"
