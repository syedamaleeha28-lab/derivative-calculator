...
export const productRulePage: CalculatorPageConfig = {
  ...
  meta: {
    title: "Calculadora Regla del Producto — Evita Errores de Signo",
    description:
...
export const quotientRulePage: CalculatorPageConfig = {
  ...
  meta: {
    title: "Calculadora Regla del Cociente — Sin Errores de Signo",
    description:
...
export const higherOrderDerivativePage: CalculatorPageConfig = {
  ...
  meta: {
    title: "Calculadora de Derivadas de Orden Superior (hasta la n-ésima)",
    description:
...
export const tangentLinePage: CalculatorPageConfig = {
  ...
  meta: {
    title: "Calculadora de Recta Tangente — Pendiente y Ecuación al Instante",
    description:
...
export const criticalPointsPage: CalculatorPageConfig = {
  ...
  meta: {
    title: "Calculadora de Puntos Críticos — Máximos y Mínimos con Pasos",
    description:
