...
export const LOCALE_ROUTE_PAIRS: { es: string; en: string }[] = [
  ...
  { es: ES_CALCULATOR_ROUTES.continuity, en: EN_ROUTES.continuityCalculator },
  ...
  { es: ES_COMMON_FUNCTION_ROUTES.derivadaDeArcotangente, en: EN_ROUTES.derivativeOfArctan },
  { es: ES_COMMON_FUNCTION_ROUTES.derivadaDeSecante, en: EN_ROUTES.derivativeOfSecant },
  { es: ES_COMMON_FUNCTION_ROUTES.derivadaDeArcoseno, en: EN_ROUTES.derivativeOfArcsin },
