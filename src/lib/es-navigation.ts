...
export const ES_GUIDES_NAV: EsNavLink[] = [
  ...
  { name: "Aplicaciones de la derivada", href: ES_AUTHORITY_ROUTES.aplicacionesDeLaDerivada },
  { name: "Regla de L'Hôpital", href: ES_AUTHORITY_ROUTES.reglaDeLHopital },
  { name: "Derivadas trigonométricas", href: ES_AUTHORITY_ROUTES.derivadasDeFuncionesTrigonometricas },
